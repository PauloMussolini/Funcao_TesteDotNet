...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoBeneficiario : AcessoDados
    {
        ...
        /// </summary>
        /// <param idcliente=idCliente>Lista de Beneficiarios</param>
        internal List<Beneficiario> Pesquisa(long idCliente, int iniciarEm, int quantidade, string campoOrdenacao, bool crescente, out int qtd)
        {
            ...
            List<DML.Beneficiario> benefics = Converter(ds);
        ...
        internal bool VerificarExistencia(long idCliente, string CPF)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();
